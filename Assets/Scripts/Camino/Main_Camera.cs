...
public class Main_Camera : MonoBehaviour
{
    ...
    float posX, posY; // Posicion suavizada de la camara hacia el jugador 
    ...
    public float dragSpeed = 4f; // Velocidad de movimiento de la cámara en drag
    ...
    public float tiempoHastaCentrarse = 5f; // Tiempo hasta que la cámara se vuelva a centrar en el personaje
...
private Vector3 originalPosition; // Posición original de la cámara al empexzar a arrastrar
    ...
    void Update()
    {
        ...
        if (!camaraBloqueada){
            ...
            if ((!Input.GetMouseButton(0) || cartaEnArrastre) && (Time.realtimeSinceStartup - timeDragging) > tiempoHastaCentrarse){
                dragging = false;
            }
